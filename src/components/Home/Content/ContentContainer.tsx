    ...
    return (
        ...
        >
            <div className="w-full lg:w-5/12 ">
                ...
                <div className="font-mono font-bold text-[32px]  lg:text-[40px] leading-[45px] mb-6">
                    {title}
                </div>
                <div className="text-[18px] leading-[28px] mb-5">{text}</div>
            ...
            <div className="w-full lg:w-6/12 relative">
                ...
                <div
                    className={`z-0 absolute right-0  lg:left-0 top-0 img-morph bg-primary-purple_light w-[350px] h-[350px] ${
                        hideBubble ? "hidden" : ""
                    }`}
                ></div>
            </div>
